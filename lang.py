...
_STRINGS = {
    "ko": {
        ...
        "mode_select_title": "조작 방식 선택",
        "mode_mobile":       "📱 모바일",
        "mode_mobile_desc":  "조이스틱 + 터치버튼",
        "mode_pc":           "🖥 PC",
        "mode_pc_desc":      "키보드 + 마우스",
        "name_label":        "플레이어 이름 (클릭해서 수정)",
    ...
    "en": {
        ...
        "mode_select_title": "Choose Controls",
        "mode_mobile":       "📱 Mobile",
        "mode_mobile_desc":  "Joystick + touch",
        "mode_pc":           "🖥 PC",
        "mode_pc_desc":      "Keyboard + mouse",
        "name_label":        "Player Name (click to edit)",
